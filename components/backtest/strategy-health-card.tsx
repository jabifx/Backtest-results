        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-2 pt-2">
            <div className="bg-muted/30 rounded-md p-2">
              ...
              <div className="text-lg font-semibold">€{stats["EXPECTANCY"].toFixed(2)}</div>
            </div>
            <div className="bg-muted/30 rounded-md p-2">
              <div className="text-xs text-muted-foreground">Rachas (Win/Loss)</div>
              <div className="text-lg font-semibold">
                <span className="text-green-500">{stats["WIN STREAK"]}</span> /
                <span className="text-red-500 ml-1">{stats["LOSE STREAK"]}</span>
              </div>
            </div>
          </div>
